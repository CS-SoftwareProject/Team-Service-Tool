...
public class TimelineComments {
  ...
  public String toString() {
    return "TimelineComments [TimeLineContent_Num=" + TimeLineContent_Num + ", Timeline_Num=" + Timeline_Num + ", comment_Num=" + comment_Num + ", userId=" + userId + ", comment_Content=" + comment_Content + ", comment_date=" + comment_date + "]";
  }
}
